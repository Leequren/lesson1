...
const usersProgresshtml = require('../models/htmlProgressUser');
const usersProgressCss = require('../models/cssProgressUser');
    ...
    if (errors.length > 0) {
        ...
        User.findOne({email: email}).then(user => {
            if (user) {
                ...
                // const newUserProgressHtml = new
                usersProgresshtml.create({
